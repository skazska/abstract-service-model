...
describe('auth', () => {
    ...
    it('#identify returns success with instance of IAuthIdentity', async () => {
    ...
    it('success of identify has method access which returns access for realm and operation', async () => {
        let identityResult = await instance.identify({key: 'x'});
